...
//   async handleRequest(config) {
//     try {
//       // For GET requests, use basic auth only
...
//       // Also add basic auth for POST/PUT/PATCH/DELETE
//       config.auth = {
//         username: process.env.SAP_USERNAME,
//         password: process.env.SAP_PASSWORD
//       };
...
//    */
//   async get(endpoint, config = {}) {
//     const url = endpoint.startsWith('http') ? endpoint : `${this.servicePath}${endpoint}`;
//     return this.client.get(url, config);
//   }
